import SwaggerImage from '@/assets/images/swagger.png'
          ...
          <div className="flex flex-col items-center justify-center py-20">
            <div className="flex flex-col items-center mt-8 max-w-3xl">
              ...
              <p className="text-base md:text-lg mt-6 text-center">
                Access Detailed and Accurate Geographic Data Through Our User-Friendly API and
                Explore Various Tools and Resources Tailored for Developers and Researchers.
              </p>
